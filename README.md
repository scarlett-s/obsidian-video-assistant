...
Obsidian Video Assistant 是一个用于辅助视频学习与笔记记录的插件，主要适用于以下两个场景：
...
* 需在插件 Settings 中配置大语言模型
* 当前已测试支持：中文、英文、法文

注意：语法解析速度可能较慢，取决于模型性能。如出现 timed out，可重试。
...
# Obsidian Video Assistant (English)
